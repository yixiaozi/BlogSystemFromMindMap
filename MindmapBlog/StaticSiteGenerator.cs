...
public sealed class StaticSiteGenerator
{
        ...
        string? siteBaseUrl = null)
    {
        ...
        WriteSearchIndex(outDir, sortedArticles, gitSnapshot, names.AboutPageWebPath);
    ...
    private static void WriteSearchIndex(
        string outDir,
        IReadOnlyList<BlogArticle> sortedArticles,
        GitCommitHistorySnapshot? gitCommits,
        string? aboutPageWebPath)
    {
        var list = SearchIndexRecord.Build(sortedArticles, gitCommits, aboutPageWebPath);
